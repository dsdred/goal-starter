...
| 0014 | Portable Configuration — Variable Resolution и Secret-Safe Export/Import (Accepted 2026-09-13; синтаксис `${NAME}` + `$$` escape, built-in `GOAL_DATA`, процесс-окружение как источник, resolve-at-consumption, ошибки undefined-var + malformed-ref, secret-safe экспорт (только ключи), portable bundle v1, REJECT-коллизии, атомарный graph-import, 3-slice phasing; **MVP завершён — Slices 1–3 опубликованы 2026-09-15**, финальный SHA `4624d81`, CI 7/7 PASS) | Accepted |
