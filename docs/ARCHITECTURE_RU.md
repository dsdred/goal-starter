...
| 0014 | Portable Configuration — Variable Resolution и Secret-Safe Export/Import (Accepted 2026-09-13; синтаксис `${NAME}` + `$$` escape, built-in `GOAL_DATA`, процесс-окружение как источник, resolve-at-consumption, ошибки undefined-var + malformed-ref, secret-safe экспорт (только ключи), portable bundle v1, REJECT-коллизии, атомарный graph-import, 3-slice phasing; **Slice 1 реализовано 2026-09-14** — resolver, интеграция в LaunchResolver, 400-mapping, 52 теста; Slice 2/3 NOT STARTED) | Accepted |
